                        ...
                        <div class="panel">
                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                    ...
                                    <h3 class="miniStats--title h4">Read Post</h3>
                        ...
                        <div class="panel">
                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                    ...
                                    <h3 class="miniStats--title h4">Article Published</h3>
                                    <p class="miniStats--num text-green">3,130</p>
                                </div>
                            </div>
                            <!-- Mini Stats Panel End -->
                        </div>
                                        ...
                                        {{--<tbody>--}}
                                            ...
                                            {{--<tr>--}}
                                                {{--<td>--}}
                                                    {{--<div class="media">--}}
                                                        {{--<div class="media--img">--}}
                                                            {{--<img src="admin/assets/img/projects/thumb-01.jpg" alt="">--}}
                                                        {{--</div>--}}
                                                    {{--</div>--}}
                                                {{--</td>--}}
                                            ...
                                            {{--<tr>--}}
                                                {{--<td>--}}
                                                    {{--<div class="media">--}}
                                                        {{--<div class="media--img">--}}
                                                            {{--<img src="admin/assets/img/projects/thumb-02.jpg" alt="">--}}
                                                        {{--</div>--}}
                                                    {{--</div>--}}
                                                {{--</td>--}}
                                            ...
                                            {{--<tr>--}}
                                                {{--<td>--}}
                                                    {{--<div class="media">--}}
                                                        {{--<div class="media--img">--}}
                                                            {{--<img src="admin/assets/img/projects/thumb-03.jpg" alt="">--}}
                                                        {{--</div>--}}
                                                    {{--</div>--}}
                                                {{--</td>--}}
                                ...
                                {{--<div class="table-responsive">--}}
                                    {{--<table class="table style--2">--}}
                                        ...
                                        {{--<tbody>--}}
                                            {{--<!-- Table Row Start -->--}}
                                            {{--<tr>--}}
                                                {{--<td><img src="admin/assets/img/products/thumb-01.jpg" alt=""></td>--}}
                                                {{--<td>3BSD59</td>--}}
                                            ...
                                            {{--<!-- Table Row Start -->--}}
                                            {{--<tr>--}}
                                                {{--<td><img src="admin/assets/img/products/thumb-02.jpg" alt=""></td>--}}
                                                {{--<td>3BSD59</td>--}}
                                                {{--<td><a href="#" class="btn-link">Leisure Suit Casual</a></td>--}}
                                                {{--<td>$99</td>--}}
                                                {{--<td>2</td>--}}
                                            ...
                                            {{--<!-- Table Row Start -->--}}
                                            {{--<tr>--}}
                                                {{--<td><img src="admin/assets/img/products/thumb-03.jpg" alt=""></td>--}}
                                                {{--<td>3BSD59</td>--}}
                                                {{--<td><a href="#" class="btn-link">Leisure Suit Casual</a></td>--}}
                                                {{--<td>$99</td>--}}
                                                {{--<td>2</td>--}}
                    ...
                    {{--<div class="col-xl-6">--}}
                        {{--<div class="panel">--}}
                            {{--<div class="profile--panel">--}}
                                {{--<div class="img-wrapper" data-bg-img="admin/assets/img/covers/01_800x150.jpg">--}}
                                    {{--<div class="img online">--}}
                                        {{--<img src="admin/assets/img/avatars/01_150x150.png" alt="" class="rounded-circle">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                        ...
                        {{--<div class="panel">--}}
                            ...
                            {{--<div class="comments-panel">--}}
                                {{--<ul>--}}
                                    {{--<li>--}}
                                        {{--<div class="img">--}}
                                            {{--<img src="admin/assets/img/avatars/02_40x40.png" alt="" class="rounded-circle">--}}
                                        {{--</div>--}}
                                    ...
                                    {{--<li>--}}
                                        {{--<div class="img">--}}
                                            {{--<img src="admin/assets/img/avatars/03_40x40.png" alt="" class="rounded-circle">--}}
                                        {{--</div>--}}
                                    ...
                                    {{--<li>--}}
                                        {{--<div class="img">--}}
                                            {{--<img src="admin/assets/img/avatars/04_40x40.png" alt="" class="rounded-circle">--}}
                                        {{--</div>--}}
